...
import { Loader2, CheckCircle, XCircle, AlertTriangle, Clock, ChevronsUpDown, Check } from 'lucide-react';
...
export default function Create() {
    ...
    const handleCancel = () => {
        if(data.nombre || data.apellido || data.dni || data.telefono || data.correo || data.area) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                <h1 className="text-2xl font-bold">Alta Responsable</h1>
                <Card>
                        ...
                        <CardContent className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <Input
                                    ...
                                    placeholder="Ejemplo: 388-5474266"
                                    maxLength={11}
                                />
