...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        ...
        telefono: '',
        correo: '',
        especialidad: '', // Cambiado de 'area' a 'especialidad'
        experiencia: '', // Campo adicional para capacitadores
    });

    // Estado para validaciones en tiempo real
    const [validationState, setValidationState] = React.useState<ValidationState>({});

    // Funciones de formateo (igual que en responsables)
    ...
    // Validaciones (igual que en responsables)
    ...
    // Funciones de validación visual (igual que en responsables)
    ...
    const handleCancel = () => {
        if(data.nombre || data.apellido || data.dni || data.telefono || data.correo || data.especialidad || data.experiencia) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                <h1 className="text-2xl font-bold">Alta Capacitador</h1>
                <Card>
